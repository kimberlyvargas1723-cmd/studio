...
// MODIFICADO: Importar el hook useDatabase para acceder a la Realtime Database
...
export default function DashboardPage({ learningStyle }: DashboardPageProps) {
  ...
  // MODIFICADO: Obtener la instancia de la base de datos desde el hook centralizado.
  ...
  // Ahora es más robusto porque se ejecuta solo cuando la instancia de `database` está disponible.
  useEffect(() => {
    // Solo ejecutar si la base de datos está disponible (se ha inicializado).
    if (!database) return;
