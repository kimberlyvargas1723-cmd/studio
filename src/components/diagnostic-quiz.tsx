...
/**
 * A dedicated component for the initial diagnostic quiz during onboarding.
 * It guides the user through the learning style questionnaire and, upon completion,
 * generates and saves their personalized learning strategy before redirecting them
  ...
  return (
    <div className="flex min-h-screen w-full items-center justify-center bg-muted/40 p-4">
        ...
        {!isQuizFinished ? (
            <>
            <CardHeader>
                <CardTitle className="font-headline text-2xl">Diagnóstico de Estilo de Aprendizaje</CardTitle>
                <CardDescription>
                Pregunta {currentQuestionIndex + 1} de {learningStyleQuiz.length}. Elige la opción que mejor te describa.
                </CardDescription>
            </CardHeader>
